...
def cmd_full(args, config):
    ...
    print(f"{'='*80}\n")
    print(f"This will run the complete workflow:")
    ...
    print(f"🐉 Tested: {len(strategies)} strategies × {len(lookbacks)} lookbacks × {len(config['backtest']['risk_levels'])} risk levels")
    print(f"{'='*80}\n")
